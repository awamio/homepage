    ...
    <main className="grid min-h-screen place-content-center gap-30">
      ...
      <div className="grid place-content-center gap-10 px-4 md:place-content-start">
        <section className="animate-fade-in-up grid gap-3">
          <h2 className="size-fit rounded-lg bg-sky-100 px-3 py-1 text-center text-xl text-slate-500 decoration-2 underline-offset-3 hover:text-slate-600 dark:bg-sky-900/80 dark:text-sky-200 dark:hover:text-sky-100">
            About
          </h2>
